...
l1=Label(root,text="welcome to our website",font=("arial",20,"bold","underline"),bg="lightblue",fg="blue")
l1.pack()


# button

b1=Button(root,text="login",font=(20),bg="pink",fg="black")
b1.place(x=250,y=70)


b2=Button(root,text="Register",font=(20),bg="pink",fg="black",command=Register)
